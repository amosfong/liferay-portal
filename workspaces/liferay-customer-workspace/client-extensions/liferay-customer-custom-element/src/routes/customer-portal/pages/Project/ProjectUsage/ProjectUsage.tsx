...
const ProjectUsage = () => {
	...
	const isLoading =
		koroneikiAccountLoading || myUserAccountLoading || projectUsageLoading;
	...
	if (
		...
		(featureFlags.includes('LRSD-6322') &&
			!featureFlags.includes('LRSD-7805') &&
			!myUserAccount?.isLiferayStaff) ||
		(featureFlags.includes('LRSD-7805') &&
			!myUserAccount?.isLiferayStaff &&
			!myUserAccount?.isPartner)
	) {
				...
				<div className="position-relative">
					...
					{displayUsage && (
						<>
							...
							<ContactBanner
								description={i18n.translate(
									'dont-let-resources-limit-your-project'
								)}
								title={i18n.translate(
